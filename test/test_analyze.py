...
class test_analyze(unittest.TestCase):
    def __init__(self, debug, cfg):
        ...
        self.cfg = cfg
        self.util = util.util(
            debug, cfg.getfloatoption("characteristic", "PEAK_FACTOR")
        )
    ...
    def test_analyze_get_match(self):
        ...
        for t in range(1, 4):
            ...
            self.assertSequenceEqual(
                result, correct_object, "test_analyze_get_match(" + str(t) + ") failed!"
            )
        ...
        self.assertSequenceEqual(
            result, correct_object, "test_analyze_get_match leading results failed!"
        )
        ...
        self.assertSequenceEqual(
            result, correct_object, "test_analyze_get_match ending results failed!"
        )
        ...
        self.assertSequenceEqual(
            result, correct_object, "test_analyze_get_match order results failed!"
        )
    ...
    def create_test_framing_order_strict_length(self):
        ...
        too_short = single_frames[0][
            0 : len(single_frames[0])
