...
class test_audio(unittest.TestCase):
    ...
    def test_environment(self):
        self.assertGreaterEqual(
            ...
            4,
            "SOPARE requires a multiprocessor architecture and was tested with at least 4 cores (e.g. RPi2/3)",
        )
    ...
    def test_results(self):
        ...
        if found:
            best = sorted(
                recommendations, key=recommendations.__getitem__, reverse=True
            )
